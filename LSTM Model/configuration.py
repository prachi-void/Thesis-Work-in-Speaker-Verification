...
data_arg.add_argument('--noise_path', type=str, default='DS_10283_1942/Experiments/clean_noisy_train', help="noise dataset directory")
data_arg.add_argument('--train_path', type=str, default='DS_10283_1942/Experiments/clean_train', help="train dataset directory")
data_arg.add_argument('--test_path', type=str, default='DS_10283_1942/Experiments/clean_noisy_test', help="test dataset directory")
...
model_arg.add_argument('--model_path', type=str, default='tisv_model_clean', help="model directory to save or load")
...
train_arg.add_argument('--iteration', type=int, default=5000, help="max iteration")
